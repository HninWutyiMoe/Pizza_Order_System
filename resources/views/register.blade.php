...
@section('content')
    ...
    <div class="login-form">
        ...
        <form action="{{ route('register') }}" method="post">
            ...
            <div class="form-group">
                <label>Phone</label>
                <input class="au-input au-input--full" type="number" name="phone" placeholder="09-xxxxxxxxx">
            </div>
            @error('phone')
                <small class="text-danger">{{ $message }}</small>
            @enderror
            ...
            <div class="form-group">
                <label>Address</label>
                <input class="au-input au-input--full" type= "text-area" name="address" placeholder="Address">
            </div>
            @error('address')
                <small class="text-danger">{{ $message }}</small>
            @enderror
