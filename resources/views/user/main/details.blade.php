    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                ...
                <a href="{{ route('user#home') }}"><i class="fa-solid fa-arrow-left-long mb-3 text-dark"></i></a>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-3">
                        <small class="pt-1"><i class="fa-regular fa-eye ms-1"></i>
                            {{ $pizza->view_count + 1 }}
                        </small>
                    </div>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        ...
                        <button type="button" id="addCartBtn" class="btn btn-danger px-3"><i
                    ...
                    @foreach ($pizzaList as $pL)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('storage/' . $pL->image) }}"
                                    style="height:220px;">
