        ...
        <div class="section__content section__content--p30">
            <div class="container-fluid">
                <div class="col-md-12">
                    ...
                    <div class="table-data__tool">
                        <div class="table-data__tool-left">
                            <div class="overview-wrap">
                                <h2 class="title-1">Categoryt List</h2>
                    ...
                    <div class="row pb-3">
                        <div class="col-3">
                            <h5><i class="fa-solid fa-database"></i> {{ $categories->total() }}</h5>
                        </div>
                    </div>
                    ...
                    @else
                        <h2 class="text-secondary text-center mt-4">There is no category here</h2>
                    @endif
                    <!-- END DATA TABLE -->
                </div>
            </div>
