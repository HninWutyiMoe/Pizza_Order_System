                ...
                <div class="bg-light p-4 mb-30">
                    <form>
                        <div class="d-flex align-items-center justify-content-between mb-3 bg-dark text-white px-3 py-1">
                            ...
                            <span class="badge border font_weight-normal">{{ count($category) }}</span>
                        </div>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <div>
                                <a href="{{ route('user#cartList') }}">
                                    <button type="button" class="btn btn-sm bg-dark text-warning position-relative me-3">
                                ...
                                <a href="{{ route('user#history') }}">
                                    <button type="button" class="btn btn-sm bg-dark text-warning position-relative">
