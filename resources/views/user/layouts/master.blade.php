                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                {{-- <ul class="dropdown-menu">
                                    <li><a class="dropdown-item my-3" href="{{ route('user#changeProfile') }}">
                                            <i class="fa-solid fa-user-large me-2"></i>Account
                                        </a>
                                    </li>
                                    <li><a class="dropdown-item my-3" href="{{ route('user#changePassword') }}">
                                            <i class="fa-solid fa-key me-2"></i>Change Password
                                        </a>
                                    </li>
                                    <li><span class="dropdown-item my-3">
                                            <form action="{{ route('logout') }}" method="POST" class="d-inline">
                                                @csrf
                                                <button class="btn bg-dark text-white" type="submit">
                                                    <i class="fa-solid fa-arrow-right-from-bracket pr-1"></i>Logout
                                                </button>
                                            </form>
                                        </span>
                                    </li>
                                ...
                                <div class="dropdown-menu user-profile ">
                                    <a href="{{ route('user#changeProfile') }}" class="dropdown-item profile">
